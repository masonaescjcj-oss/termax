...
export const mapUserToSnake = (appUser: any): any => {
    ...
    if (appUser.riskGuard !== undefined) snake.risk_guard = appUser.riskGuard;
...
export const mapPositionToSnake = (appPos: any): any => {
    ...
    if (appPos.botId !== undefined) snake.bot_id = appPos.botId;
