...
const STYLES = { grid: { horizontal: { color: 'rgba(255,255,255,0.04)' }, vertical: { color: 'rgba(255,255,255,0.04)' } }, candle: { bar: { upColor: '#089981', downColor: '#f23645', upBorderColor: '#089981', downBorderColor: '#f23645', upWickColor: '#089981', downWickColor: '#f23645' }, tooltip: { showRule: 'none' }, priceMark: { last: { upColor: '#089981', downColor: '#f23645' } } }, xAxis: { axisLine: { color: 'rgba(255,255,255,0.09)' }, tickLine: { color: 'rgba(255,255,255,0.09)' }, tickText: { color: '#787b86', size: 11 } }, yAxis: { axisLine: { color: 'rgba(255,255,255,0.09)' }, tickLine: { color: 'rgba(255,255,255,0.09)' }, tickText: { color: '#787b86', size: 11 } }, crosshair: { horizontal: { text: { backgroundColor: 'rgba(30,34,45,0.92)' } }, vertical: { text: { backgroundColor: 'rgba(30,34,45,0.92)' } } } } as any;
